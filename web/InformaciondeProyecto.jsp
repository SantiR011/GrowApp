<%-- 
    Document   : InformaciondeProyecto
    Created on : 19/04/2024, 8:22:49 p. m.
    Author     : Usuario
--%>
...
<html>
    ...
    <div class="d-flex justify-content-center align-items-center">
        <div class="card col-sm-3">
            <div class="card-body">
                <form action="Controlador?menu=InformaciondeProyecto" method="POST">
                    <div class="form-group">
                        <label>Modulo: ${progreso.getId()}</label>
                    </div>
                    <div class="form-group">
                        <label>Porcentaje</label>
                        <input type="text" value="${progreso.getPorcentaje()}" name="txtPorcentaje" class="form-control">
                    </div>
                ...
                <tbody>
                    <c:forEach var="pr" items="${progresos}">
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-warning" href="Controlador?menu=InformaciondeProyecto&accion=Editar&id=${pr.getId()}">Editar</a>
                            </td>
                        </tr>
                    </c:forEach>
                </tbody>
